...
def update_ui(choice):
    ...
    if choice == "Bitly":
        ...
        bitly_key_label.pack_forget()
        bitly_key_entry.pack_forget()
...
# วิดเจ็ตสำหรับ Bitly API Key (ซ่อนไว้ก่อน)
bitly_key_label = ctk.CTkLabel(root, text="Bitly API Key")
bitly_key_entry = ctk.CTkEntry(root, width=300, show="*")
